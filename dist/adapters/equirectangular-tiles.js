    ...
    _proto.__refresh = function __refresh(init) {
      ...
      for (var col = 0; col < panorama.cols; col++) {
        for (var row = 0; row < panorama.rows; row++) {
          ...
          if (row === 0) {
            // bottom-left
            var v0 = this.prop.facesByRow === 1 ? col * this.prop.facesByCol * this.NB_VERTICES_BY_SMALL_FACE + 1 : this.SPHERE_SEGMENTS * this.NB_VERTICES_BY_SMALL_FACE + (this.prop.facesByRow - 2) * this.SPHERE_SEGMENTS * this.NB_VERTICES_BY_FACE + col * this.prop.facesByCol * this.NB_VERTICES_BY_FACE + 4;

            // bottom-right
            var v1 = this.prop.facesByRow === 1 ? v0 + (this.prop.facesByCol - 1) * this.NB_VERTICES_BY_SMALL_FACE + 1 : v0 + (this.prop.facesByCol - 1) * this.NB_VERTICES_BY_FACE + 1;
            ...
            if (this.prop.facesByRow >= this.SPHERE_HORIZONTAL_SEGMENTS / 4) {
              // left-center
              var v6 = v0 - this.prop.facesByRow / 2 * this.SPHERE_SEGMENTS * this.NB_VERTICES_BY_FACE;
            ...
            // top-left
            var _v = this.prop.facesByRow === 1 ? -this.SPHERE_SEGMENTS * this.NB_VERTICES_BY_SMALL_FACE + row * this.prop.facesByRow * this.SPHERE_SEGMENTS * this.NB_VERTICES_BY_FACE + col * this.prop.facesByCol * this.NB_VERTICES_BY_SMALL_FACE + 1 : -this.SPHERE_SEGMENTS * this.NB_VERTICES_BY_SMALL_FACE + row * this.prop.facesByRow * this.SPHERE_SEGMENTS * this.NB_VERTICES_BY_FACE + col * this.prop.facesByCol * this.NB_VERTICES_BY_FACE + 1;

            // top-right
            var _v2 = this.prop.facesByRow === 1 ? _v + (this.prop.facesByCol - 1) * this.NB_VERTICES_BY_SMALL_FACE - 1 : _v + (this.prop.facesByCol - 1) * this.NB_VERTICES_BY_FACE - 1;
            ...
            if (this.prop.facesByRow >= this.SPHERE_HORIZONTAL_SEGMENTS / 4) {
              // left-center
              var _v5 = _v + this.prop.facesByRow / 2 * this.SPHERE_SEGMENTS * this.NB_VERTICES_BY_FACE;
            ...
            // top-left
            var _v7 = -this.SPHERE_SEGMENTS * this.NB_VERTICES_BY_SMALL_FACE + row * this.prop.facesByRow * this.SPHERE_SEGMENTS * this.NB_VERTICES_BY_FACE + col * this.prop.facesByCol * this.NB_VERTICES_BY_FACE + 1;

            // bottom-left
            var _v8 = _v7 + (this.prop.facesByRow - 1) * this.SPHERE_SEGMENTS * this.NB_VERTICES_BY_FACE + 3;

            // bottom-right
            var _v9 = _v8 + (this.prop.facesByCol - 1) * this.NB_VERTICES_BY_FACE + 1;
            ...
            if (this.prop.facesByCol >= this.SPHERE_SEGMENTS / 8) {
              // top-center
              var _v10 = _v7 + this.prop.facesByCol / 2 * this.NB_VERTICES_BY_FACE;
            ...
            if (this.prop.facesByRow >= this.SPHERE_HORIZONTAL_SEGMENTS / 4) {
              // left-center
              var _v11 = _v7 + this.prop.facesByRow / 2 * this.SPHERE_SEGMENTS * this.NB_VERTICES_BY_FACE;
    ...
    _proto.__swapMaterial = function __swapMaterial(col, row, material) {
      ...
      for (var c = 0; c < this.prop.facesByCol; c++) {
        var _loop = function _loop(r) {
          ...
          var isLastRow = faceRow === _this7.SPHERE_HORIZONTAL_SEGMENTS - 1;
          ...
          _this7.prop.materials[matIndex] = material;
